<div class="mt-5">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
        ...
        <div class="flex justify-between items-center text-gray-700 mb-6">
            ...
            <a href="{{route('student_create')}}" class="bg-blue-500 rounded-md p-2 text-sm text-white hover:bg-blue-900 transition ease-out">Ajouter niveau</a>
        </div>
        {{-- message de succes --}}
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            <button  type="button" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white 
                                                        ...
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            ...
                                                            <a href={{route('student_edit',$items->id)}}>Modifier</a>
                                            </button>
